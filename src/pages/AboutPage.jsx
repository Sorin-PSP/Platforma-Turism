    ...
    <div>
      <div className="bg-primary-dark text-white py-16">
        <div className="container-custom">
          <h1 className="text-4xl font-bold mb-4">Despre TravelRo</h1>
      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-700 mb-6">
              La TravelRo, misiunea noastră este să simplificăm procesul de căutare și rezervare a vacanțelor, oferind acces la o gamă largă de oferte turistice de la agenții de renume din România și din străinătate.
            </p>
            <p className="text-gray-700 mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p>Oferim transparență totală în privința prețurilor și serviciilor incluse</p>
              </div>
              <div className="flex items-start">
                <FaCheckCircle className="text-primary mt-1 mr-3" />
              ...
              <div className="flex items-start">
                <FaCheckCircle className="text-primary mt-1 mr-3" />
                <p>Actualizăm constant ofertele pentru a reflecta cele mai recente promoții</p>
              </div>
            </div>
          </div>
          <div>
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-12">De ce să alegi TravelRo</h2>
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-700 mb-4">
              TravelRo a fost fondată în 2020 de către un grup de entuziaști ai călătoriilor care au observat dificultatea de a compara ofertele turistice disponibile pe piața din România.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-4">
              Astăzi, TravelRo este utilizată de mii de români pentru a-și planifica vacanțele, economisind în medie 15% din costul total al călătoriilor lor.
            </p>
